                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="unit_id" id="final_unit_id" value="{{ old('unit_id', $soldier->unit_id) }}" required>
                                    @error('unit_id')
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('birth_date') is-invalid @enderror" id="birth_date" name="birth_date" value="{{ old('birth_date', $soldier->birth_date ? $soldier->birth_date->format('Y-m-d') : '') }}" required>
                                    @error('birth_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('enlistment_date') is-invalid @enderror" id="enlistment_date" name="enlistment_date" value="{{ old('enlistment_date', $soldier->enlistment_date ? $soldier->enlistment_date->format('Y-m-d') : '') }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('party_join_date') is-invalid @enderror" id="party_join_date" name="party_join_date" value="{{ old('party_join_date', $soldier->party_join_date ? $soldier->party_join_date->format('Y-m-d') : '') }}">
