                            ...
                            <div class="d-flex flex-wrap gap-3">
                                ...
                                <div class="form-group border p-2 rounded">
                                    ...
                                    <select name="attendance_{{ $key }}" class="form-control form-control-sm">
                                        <option value="">-</option>
                                        <option value="+" {{ old('attendance_'.$key) == '+' ? 'selected' : '' }}>+</option>
                                        <option value="x" {{ old('attendance_'.$key) == 'x' ? 'selected' : '' }}>x</option>
                                        <option value="-" {{ old('attendance_'.$key) == '-' ? 'selected' : '' }}>-</option>
                                    </select>
                                </div>
                                @endforeach
                            </div>
                            <small class="text-muted mt-1 d-block">Chú thích: (+): Có mặt, (x): Vắng có lý do, (-): Vắng không lý do</small>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="test_quanso" name="test_quanso" value="{{ old('test_quanso', 0) }}" min="0">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="good_count">Giỏi</label>
                                <input type="number" class="form-control" id="good_count" name="good_count" value="{{ old('good_count', 0) }}" min="0">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="fair_count">Khá</label>
                                <input type="number" class="form-control" id="fair_count" name="fair_count" value="{{ old('fair_count', 0) }}" min="0">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="pass_count">Trung bình</label>
                                <input type="number" class="form-control" id="pass_count" name="pass_count" value="{{ old('pass_count', 0) }}" min="0">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="fail_count">Yếu</label>
                                <input type="number" class="form-control" id="fail_count" name="fail_count" value="{{ old('fail_count', 0) }}" min="0">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="rating" name="rating" required>
                                    ...
                                    <option value="trung_bình" {{ old('rating', 'trung_bình') == 'trung_bình' ? 'selected' : '' }}>Trung bình</option>
                    ...
                    <div class="form-group mt-3">
                        ...
                        <textarea class="form-control" id="general_evaluation" name="general_evaluation" rows="2">{{ old('general_evaluation') }}</textarea>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        // Tự động cập nhật Thứ khi thay đổi ngày
