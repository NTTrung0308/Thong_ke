...
@section('dashboard_content')
    <div class="page-header">
        <h3 class="fw-bold mb-3">Chỉnh sửa kết quả tập huấn</h3>
    ...
    <form action="{{ route('training-results.update', $trainingResult->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="unit_id" id="final_unit_id" value="{{ old('unit_id', $trainingResult->unit_id) }}" required>
                                    @error('unit_id')
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('training_date') is-invalid @enderror" id="training_date" name="training_date" value="{{ old('training_date', $trainingResult->training_date ? $trainingResult->training_date->format('Y-m-d') : '') }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control @error('start_time') is-invalid @enderror" id="start_time" name="start_time" value="{{ old('start_time', $trainingResult->start_time ? $trainingResult->start_time->format('H:i') : '') }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control @error('end_time') is-invalid @enderror" id="end_time" name="end_time" value="{{ old('end_time', $trainingResult->end_time ? $trainingResult->end_time->format('H:i') : '') }}" required>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('content') is-invalid @enderror" id="content" name="content" value="{{ old('content', $trainingResult->content) }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('trung_doi_count') is-invalid @enderror" id="trung_doi_count" name="trung_doi_count" value="{{ old('trung_doi_count', $trainingResult->trung_doi_count) }}" required min="0">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('at_count') is-invalid @enderror" id="at_count" name="at_count" value="{{ old('at_count', $trainingResult->at_count) }}" required min="0">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('kdt_count') is-invalid @enderror" id="kdt_count" name="kdt_count" value="{{ old('kdt_count', $trainingResult->kdt_count) }}" required min="0">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-select @error('result') is-invalid @enderror" id="result" name="result" required>
                                        ...
                                        <option value="xuất_sắc" {{ old('result', $trainingResult->result) == 'xuất_sắc' ? 'selected' : '' }}>Xuất sắc</option>
                                        <option value="giỏi" {{ old('result', $trainingResult->result) == 'giỏi' ? 'selected' : '' }}>Giỏi</option>
                                        <option value="khá" {{ old('result', $trainingResult->result) == 'khá' ? 'selected' : '' }}>Khá</option>
                                        <option value="trung_bình" {{ old('result', $trainingResult->result) == 'trung_bình' ? 'selected' : '' }}>Trung bình</option>
                                        <option value="yếu" {{ old('result', $trainingResult->result) == 'yếu' ? 'selected' : '' }}>Yếu</option>
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('passing_rate') is-invalid @enderror" id="passing_rate" name="passing_rate" value="{{ old('passing_rate', $trainingResult->passing_rate) }}" min="0" max="100">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="instructor" name="instructor" value="{{ old('instructor', $trainingResult->instructor) }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="supervisor">Người kiểm tra/Giám sát</label>
                                    <input type="text" class="form-control" id="supervisor" name="supervisor" value="{{ old('supervisor', $trainingResult->supervisor) }}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="result_details">Chi tiết kết quả</label>
                                    <textarea class="form-control" id="result_details" name="result_details" rows="3">{{ old('result_details', $trainingResult->result_details) }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="evaluation">Đánh giá chung</label>
                                    <textarea class="form-control" id="evaluation" name="evaluation" rows="3">{{ old('evaluation', $trainingResult->evaluation) }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="strengths">Ưu điểm</label>
                                    <textarea class="form-control" id="strengths" name="strengths" rows="3">{{ old('strengths', $trainingResult->strengths) }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="weaknesses">Khuyết điểm/Tồn tại</label>
                                    <textarea class="form-control" id="weaknesses" name="weaknesses" rows="3">{{ old('weaknesses', $trainingResult->weaknesses) }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="recommendations">Biện pháp khắc phục/Đề xuất</label>
                                    <textarea class="form-control" id="recommendations" name="recommendations" rows="3">{{ old('recommendations', $trainingResult->recommendations) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-12 mb-5">
                <div class="card">
                    <div class="card-body text-center">
                        <button type="submit" class="btn btn-primary btn-lg">Cập nhật kết quả</button>
